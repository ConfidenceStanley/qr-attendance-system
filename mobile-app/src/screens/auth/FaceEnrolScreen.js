...
const FaceEnrolScreen = () => {
  ...
  const { isFaceLoading, faceError } = useSelector((state) => state.auth);
  ...
  const handleCapture = async () => {
    ...
    try {
      ...
      if (enrolFace.fulfilled.match(result)) {
        ...
        // Fail — show error on camera screen, camera stays active
  ...
  // ── Instructions screen (before camera) ──
  if (showInstructions) {
    return (
      <View style={styles.instructionScreen}>
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            This is a one-time setup. Your face will verify your identity every login.
          </Text>
    ...
    return (
      <View style={styles.successScreen}>
        <View style={styles.card}>
          ...
          <Text style={styles.cardTitle}>Face ID Enrolled!</Text>
          <Text style={styles.cardText}>
            Your face has been saved. You will verify your face every time you log in.
          </Text>
          <TouchableOpacity
            style={styles.primaryBtn}
            onPress={() => dispatch(clearFaceError())}
          >
  ...
  return (
    <View style={styles.container}>
      {/* Live camera — always mounted so it stays active */}
      <CameraView
        ref={cameraRef}
      ...
      {/* Error banner — shown on camera screen, camera stays active */}
      {localError ? (
